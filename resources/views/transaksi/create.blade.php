...
<script>
    ...
    let total = '' + ($("#id_barang-0 option:selected").attr('data-value') * $("#qty-0").val())
        ...
        if(jumlahBarang < 2)
            ...
            $("#id_barang-"+i+"").on({
                change: function () {
                    ...
                    let total = '' + ($("#id_barang-"+i+" option:selected").attr('data-value') * $("#qty-"+i+"").val())
    ...
    function totalAll(){
        ...
        var total_all  = 0
        qty_all.forEach(row => {
            total_all += row * $("#id_barang-"+i+" option:selected").attr('data-value')
            i++
        })
